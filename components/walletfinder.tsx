    ...
    wallets: [
      {
        ...
        notes:
          "QR works for standard transfer URLs but not custom checkout flows.",
      },
      {
        name: "Solflare",
      ...
      },
      {
        ...
        test_date: "2025-07-12",
        notes: "DEX-first UX, no QR parser.",
      },
      {
        name: "Bitget Wallet",
      ...
      },
      {
        ...
        notes: "QR works for USDC transfers; fails on complex invoices.",
      },
      {
        name: "Slope",
        website_url: "https://slope.finance",
        image_url: "https://slope.finance/_nuxt/img/logo-bg1.c2aeb84.png",
        platforms: ["iOS", "Android"],
        custody_model: "Self-custody",
        features: {
          in_app_dex_swap: false,
      ...
      },
      {
        ...
        notes: "QR works in extension; mobile requires extra tap.",
      },
      {
        name: "Guarda Wallet",
      ...
      },
      {
        ...
        test_date: "2025-07-15",
        notes: "Generates payment links; QR scanning requires external app.",
      },
      {
      ...
      },
      {
        ...
        test_date: "2025-07-15",
        notes: "Requires companion mobile wallet; no native QR.",
      },
      {
        name: "Trezor Model T",
      ...
      },
      {
        ...
        version_tested: "1.0",
        test_date: "2025-07-15",
        notes: "Air-gapped; QR shown only for address receive.",
      },
      {
        name: "Tangem Wallet",
      ...
      },
      {
        ...
        image_url: "https://ottr.finance/favicon.ico",
        platforms: ["iOS", "Android"],
      ...
      },
      {
        ...
        notes: "QR reader limited to SOL/USDC payments.",
      },
      {
        name: "Tiplink",
      ...
      },
      {
        ...
        test_date: "2025-07-14",
        notes: "Reads QR codes but prompts user to choose network.",
      },
      {
        name: "XDEFI Wallet",
        ...
        test_date: "2025-07-15",
        notes: "Multi-chain QR parsing; Solana invoices supported.",
      },
    ],
  };
